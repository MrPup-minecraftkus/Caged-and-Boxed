...
public class ModItemGroups {
    ...
    public static final Supplier<CreativeModeTab> CAGED = CREATIVE_MODE_TAB.register("caged_and_boxed",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModBlocks.SMALL_CAGE.asItem()))
                    .title(Component.translatable("itemgroup.caged_and_boxed.caged_and_boxed"))
                    .displayItems((itemDisplayParameters, output) -> {
                        output.accept(ModBlocks.SMALL_CAGE.asItem());
                        output.accept(ModBlocks.MEDIUM_CAGE.asItem());
                        output.accept(ModBlocks.UNIVERSAL_CAGE.asItem());
                        output.accept(ModBlocks.BOX_BLOCK.asItem());
                    })
                    .build());
